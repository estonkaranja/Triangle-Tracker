function  tracker(){
  ...
  var sidea=parseFloat(collect1);
  var sideb=parseFloat(collect2);
  var sidec=parseFloat(collect3);
  var sides=[sidea,sideb,sidec];
  var type=["Your measurements form an Equilateral Triangle","Your measurements form an Isosceles Triangle","Your measurements form a Scalene Triangle","ERROR! MEASUREMENTS INPUTTED CAN NOT FORM ANY TYPE OF TRIANGLE. PLEASE TRY AGAIN!!!"]
